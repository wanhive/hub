...
public:
	 ...
	 * @return listening socket's descriptor
	 */
	 ...
	 * @param blocking true for blocking mode, false otherwise
	 * @return connected socket's descriptor
	 */
	 ...
	 * @param sv stores the socket's descriptors
